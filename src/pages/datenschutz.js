  ...
  <Layout>
    ...
    <TextPage>
      ...
      <p>
        ...
        Geschäftsleitung der IT-Consulting Grossmann. Eine Nutzung der
        Internetseiten der IT-Consulting Grossmann ist grundsätzlich ohne jede
      ...
      <p>
        ...
        Übereinstimmung mit den für die IT-Consulting Grossmann geltenden
      ...
      <p>
        {" "}
        Die IT-Consulting Grossmann hat als für die Verarbeitung
      ...
      <p>
        {" "}
        Die Datenschutzerklärung der IT-Consulting Grossmann beruht auf den
      ...
      <p>
        ...
        <br />
        E-Mail: it-consulting-grossmann@t-online.de
        <br />
        Website: www.it-consulting-grossmann.de{" "}
      </p>
      <h3>3. Erfassung von allgemeinen Daten und Informationen</h3>
      <p>
        {" "}
        Die Internetseite der IT-Consulting Grossmann erfasst mit jedem Aufruf
      ...
      <p>
        ...
        IT-Consulting Grossmann keine Rückschlüsse auf die betroffene Person.
        ...
        erhobenen Daten und Informationen werden durch die IT-Consulting
        Grossmann daher einerseits statistisch und ferner mit dem Ziel
      ...
      <p>
        {" "}
        Die Internetseite der IT-Consulting Grossmann enthält aufgrund von
        ...
        oder der Kontaktaufnahme zur betroffenen Person gespeichert. Es erfolgt
      ...
      <p>
        ...
        IT-Consulting Grossmann gespeichert sind, veranlassen möchte, kann sie
        sich hierzu jederzeit an einen Mitarbeiter des für die Verarbeitung
        Verantwortlichen wenden. Der Mitarbeiter der IT-Consulting Grossmann
        wird veranlassen, dass dem Löschverlangen unverzüglich nachgekommen
        wird.{" "}
      </p>
      <p>
        {" "}
        Wurden die personenbezogenen Daten von der IT-Consulting Grossmann
        ...
        verpflichtet, so trifft die IT-Consulting Grossmann unter
        ...
        erforderlich ist. Der Mitarbeiter der IT-Consulting Grossmann wird im
      ...
      <p>
        ...
        der IT-Consulting Grossmann gespeichert sind, verlangen möchte, kann sie
        sich hierzu jederzeit an einen Mitarbeiter des für die Verarbeitung
        Verantwortlichen wenden. Der Mitarbeiter der IT-Consulting Grossmann
      ...
      <p>
        ...
        betroffene Person jederzeit an einen Mitarbeiter der IT-Consulting
        Grossmann wenden.{" "}
      </p>
      ...
      <p>
        {" "}
        Die IT-Consulting Grossmann verarbeitet die personenbezogenen Daten im
      ...
      <p>
        {" "}
        Verarbeitet die IT-Consulting Grossmann personenbezogene Daten, um
        ...
        Widerspricht die betroffene Person gegenüber der IT-Consulting Grossmann
        der Verarbeitung für Zwecke der Direktwerbung, so wird die IT-Consulting
        Grossmann die personenbezogenen Daten nicht mehr für diese Zwecke
        verarbeiten.{" "}
      </p>
      <p>
        {" "}
        ...
        Verarbeitung personenbezogener Daten, die bei der IT-Consulting
        Grossmann zu wissenschaftlichen oder historischen Forschungszwecken oder
      ...
      <p>
        ...
        direkt jeden Mitarbeiter der IT-Consulting Grossmann oder einen anderen
      ...
      <p>
        ...
        betroffenen Person, trifft die IT-Consulting Grossmann angemessene
